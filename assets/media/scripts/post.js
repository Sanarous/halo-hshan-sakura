...
var post =  {
    ...
    initToc: function () {
        var headerEl = 'h1,h2,h3,h4,h5,h6',  //headers
            content = '#post-article-content'; //文章容器
        tocbot.init({
            tocSelector: '#toc',
    ...
    tocEleRight: function () {
        ...
        if (tocEle) {
            tocEle.style.left = (screenWidth - 800) / 2 + 850 + "px";
        }
    },
    ...
    expandCode: function() {
        $(".code-toolbar").dblclick(function(){
            if($(this).hasClass("code-block-fullscreen")){
                $(this).removeClass("code-block-fullscreen");
                $("html").removeClass("code-block-fullscreen-html-scroll");
            }else{
                $(this).addClass("code-block-fullscreen");
         ...
         $(document).keyup(function(e){
            ...
            if(key == 27 && $(".code-toolbar").hasClass("code-block-fullscreen")){
              $(".code-toolbar").removeClass("code-block-fullscreen");
              $("html").removeClass("code-block-fullscreen-html-scroll");
            }
         });
    },
